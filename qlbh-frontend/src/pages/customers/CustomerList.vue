<template>
  <div class="container mt-4">
    ...
    <div class="search-filter mb-3 d-flex align-items-center gap-2">
      <div class="d-flex gap-2 align-items-center flex-nowrap" style="flex: 1 1 auto;">
        <input 
          ...
          placeholder="Tìm kiếm khách hàng theo tên, email, phone, ID..."
    ...
    <div v-if="customers.length === 0 && searchQuery && !loading" class="alert alert-info shadow-sm">
    ...
    >
      <table class="table table-bordered table-hover align-middle mb-0">
        ...
        <tbody>
          ...
          <!-- DATA -->
          <template v-else-if="paginatedCustomers.length > 0">
